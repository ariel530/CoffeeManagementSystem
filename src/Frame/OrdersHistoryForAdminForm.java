 ...
 * @author SSC
 */
public class OrdersHistoryForAdminForm extends javax.swing.JFrame {

    /**
     * Creates new form OrdersHistoy
     */
     ArrayList<Order> orderDetails = new ArrayList<>();

    public OrdersHistoryForAdminForm() {
        initComponents();
     Useables.Useable.makeImageFixToScreen("src//Images//treebg.jpg", backgroundImage, backgroundImage.getWidth(), backgroundImage.getHeight() + 1000);
        ...
        orderDetails = OrderPaymentOperation.getAlIOrder();
    ...
    private void initComponents() {
        ...
        getContentPane().add(backgroundImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 700, 420));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdersHistoryForAdminForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrdersHistoryForAdminForm().setVisible(true);
            }
        });
    }
